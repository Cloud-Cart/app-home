        ...
        <>
            <div className={'px-8'}>
                <div className={'w-full flex justify-center'}>
                    <span className={"after:content-[''] after:w-1 after:bg-black after:h-1"}>or</span>
                </div>
            </div>
            <div className={'justify-around flex flex-row items-center gap-1 mt-4'}>
                {/*google*/}
                <button className={'bg-gray-200 p-4 rounded-md w-fit'} onClick={() => {}}>
